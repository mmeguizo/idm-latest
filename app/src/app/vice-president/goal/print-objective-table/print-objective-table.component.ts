...
@Component({
    selector: 'app-print-objective-table',
    templateUrl: './print-objective-table.component.html',
    styleUrl: './print-objective-table.component.scss',
})
export class PrintObjectiveTableComponent implements OnInit {
    ...
    ngOnChanges(changes: SimpleChanges) {
        ...
        console.log(' change.currentValue', changes['printFile']?.currentValue);

        this.subOnjectiveHeaderData = header;
        this.objectiveDatas = objectData;
        this.subObjectiveHeaders = header;
...
export class PrintObjectiveTableComponent implements OnInit {
    ...
    ngOnChanges(changes: SimpleChanges) {
        const { data, header, printObjectiveTable } =
            changes['printFile']?.currentValue;
